...
func ToRange(from, to int) Range {
...
var (
	// Now that we are introducted, why do people have personal websites?
	...
	AboutMe = []string{
		...
		"I've published a card game check 'The Cemetery Game'",
		// todo: shill more the game
		...
		// todo: I mean my code is good but ain't that good.
	}
	...
	Expirience = map[Range]string{
		ToRange(1997, 2002): "Education: Istituto Superiore Vittoria Colonna, Italy",
